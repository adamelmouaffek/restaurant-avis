...
- **Pour** : Restaurants independants, brasseries, bars (1-5 etablissements)
- **Qui** : Veulent plus d'avis Google et de visibilite Maps
- **Notre produit** : Gamifie la collecte d'avis avec des cadeaux
- **Contrairement a** : Sunday (paiement seul), HeyPongo (NFC physique), Fydl (cher)
- **On se differencie par** : Avis OAuth authentiques + prix accessible + suite tout-en-un
