...
export default function KDSLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--et-bg)] flex items-center justify-center p-4">
      <div className="w-full max-w-sm flex flex-col items-center gap-8">
        <div className="flex flex-col items-center gap-3">
          <div className="w-16 h-16 rounded-2xl bg-[rgba(var(--et-accent-rgb),0.2)] flex items-center justify-center">
            <ChefHat className="w-8 h-8 text-[var(--et-accent-light)]" />
          </div>
